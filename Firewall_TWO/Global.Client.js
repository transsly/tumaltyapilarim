...
const puniUser = global.puniUser = async function(id, type) {
    ...
    return await uye.roles.cache.has(roller.boosterRolü) ? uye.roles.set([roller.boosterRolü, roller.jailRolü]).catch(err => {}) : uye.roles.set([roller.jailRolü]).catch(err => {}); 
    }
